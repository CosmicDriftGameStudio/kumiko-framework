...
// simple entity and a create-handler that writes through direct DB
// (kept intentionally simple; feature-toggle gating is what's being
// verified, not CRUD correctness).
