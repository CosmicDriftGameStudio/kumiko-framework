...
// Feature name
export const TENANT_FEATURE = "tenant";
export const MEMBERS_SCREEN_ID = "members";
export const INVITE_CREATE_SCREEN_ID = "invite-create";
export const MEMBER_ROLES_EDIT_SCREEN_ID = "member-roles-edit";
...
export const MEMBER_STATUS_CELL_COMPONENT = "MemberStatusCell";
...
export const MEMBER_ROLES_CELL_COMPONENT = "MemberRolesCell";
/** Closed allowlist for invite-role picker — never free text (escalation guard). */
export const DEFAULT_INVITE_ROLE_OPTIONS = ["User", "Editor", "Admin", "TenantAdmin"];
