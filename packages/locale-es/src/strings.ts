...
export const localeEsBundle: Readonly<Record<string, string>> = {
  ...
  "kumiko.list.filter.reset": "Restablecer",
  ...
  "kumiko.reference.system-user": "Sistema",
  ...
  "screen:my-sessions.title": "Tus sesiones",
  ...
  "sessions.mine.col.current": "Este dispositivo",
  "sessions.mine.col.ip": "Dirección IP",
  "sessions.mine.col.userAgent": "Dispositivo",
  "sessions.mine.revoke": "Cerrar sesión",
  "sessions.mine.revoke.confirm": "¿Cerrar la sesión en este dispositivo?",
  "sessions.mine.revokeAllOthers": "Cerrar sesión en los demás dispositivos",
  "sessions.mine.revokeAllOthers.confirm": "¿Cerrar sesión en todos los dispositivos excepto este?",
