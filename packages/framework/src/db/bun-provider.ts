...
export function createBunConnection(
  url: string,
  ...
  if (options.connectTimeoutSeconds !== undefined) bunOpts.connectionTimeout = options.connectTimeoutSeconds;
  ...
  if (options.connectTimeoutSeconds !== undefined) pgOpts.connect_timeout = options.connectTimeoutSeconds;
