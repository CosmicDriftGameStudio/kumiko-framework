...
// Bundles everything the (formerly nested) dispatch-phase functions closed
// over inside createDispatcher — hoisting them to module scope means those
// captures must travel explicitly instead of implicitly via closure.
...
async function resolveAuthClaimsFn(
  ctx: DispatchContext,
  user: SessionUser,
