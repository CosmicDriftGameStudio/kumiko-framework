...
export function renderDefineFile(): string {
  const body = [
    ...
    "",
    "// Optional: path-alias rather than relative imports. Add to your",
    "// tsconfig.json compilerOptions.paths:",
    `//   "@app/define": ["./.kumiko/define.ts"]`,
    `//   "@app/*":      ["./.kumiko/*"]`,
    "// Then handlers import via `from \"@app/define\"` — survives file-moves.",
    "// This file's content is unchanged either way; the alias lives in tsconfig.",
    "",
