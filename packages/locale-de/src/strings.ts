...
export const localeDeBundle: Readonly<Record<string, string>> = {
  "admin-shell:nav.myCaps": "Tarife & Limits",
  "admin-shell:nav.platformOverview": "Übersicht",
  "admin-shell:nav.tenantCaps": "Tarife & Limits",
  ...
  "audit.log.detail.subtitle":
    "Schreibgeschützte Detailansicht eines Audit-Ereignisses mit Akteur, Zeitstempel, Aggregat sowie rohem Event-Payload und Metadaten; erreichbar über eine Zeile im Audit-Log.",
  "audit.log.details": "Details",
  "audit.log.empty": "Keine Ereignisse.",
  "audit.log.filter.aggregateType": "Aggregattyp",
  ...
  "audit.log.title": "Ereignisprotokoll",
  ...
  "auth.errors.accountRestricted":
    "Konto nach Art. 18 DSGVO eingeschränkt. Hebe die Einschränkung auf, um dich wieder anzumelden.",
  ...
  "auth.errors.noMembership": "Dieses Konto hat keinen Mandanten-Zugang.",
  ...
  "auth.inviteAccept.loggedInAs":
    "Du bist als {email} angemeldet. Klicke auf „Annehmen“, um Mitglied zu werden.",
  ...
  "auth.mfa.enable.intro":
    "Schütze dein Konto zusätzlich mit einer Authenticator-App wie Google Authenticator oder 1Password.",
  ...
  "auth.mfa.setup.intro":
    "Scanne den QR-Code mit einer Authenticator-App wie Google Authenticator oder 1Password.",
  ...
  "auth.resetPassword.intro": "Wähle ein neues Passwort mit mindestens 8 Zeichen.",
  ...
  "auth.tenant.switcher.label": "Mandant",
  "auth.tenant.switcher.none": "Kein Mandant",
  ...
  "cap-overview.errors.tenantOverrideRequiresSystemAdmin":
    "Nur SystemAdmin darf Daten eines anderen Mandanten abfragen.",
  "cap-overview.errors.tierFilterOpUnsupported":
    "Dieser Filter-Operator wird für Tier nicht unterstützt.",
  "cap-overview.list.action.open": "Dashboard öffnen",
  "cap-overview.list.col.billing": "Abrechnung",
  ...
  "delivery.log.title": "Zustellprotokoll",
  ...
  "errors.conflict": "Der Vorgang konnte wegen eines Konflikts nicht abgeschlossen werden.",
  ...
  "folders.section.empty": "Noch keine Ordner angelegt.",
  ...
  "jobs.detail.field.duration": "Dauer in ms",
  ...
  "jobs.detail.logs": "Protokoll",
  "jobs.detail.logs.empty": "Keine Protokollzeilen.",
  ...
  "jobs.runs.empty": "Noch keine Job-Läufe.",
  ...
  "jobs.trigger.empty": "Es gibt keine Jobs, die sich manuell starten lassen.",
  ...
  "kumiko.config.source.tenant": "Mandant",
  ...
  "kumiko.field.embedded-list.paste-cells-unmatched":
    "{count} Zellen ohne passende Option wurden nicht geändert.",
  "kumiko.field.embedded-list.paste-rows-truncated":
    "{count} eingefügte Zeilen wurden verworfen, weil die maximale Zeilenzahl erreicht ist.",
  ...
  "kumiko.field.reference-created-no-id":
    "Der Eintrag wurde angelegt, aber nicht automatisch ausgewählt. Bitte wähle ihn manuell aus.",
  ...
  "notesHistory.section.historyTitle": "Verlauf",
  "notesHistory.section.loading": "Lädt…",
  "notesHistory.section.meta": "{author} · {date}",
  "notesHistory.section.newNoteTitle": "Neue Notiz",
  "notesHistory.section.shortcutHint": "Strg+Enter speichert",
  ...
  "pat.created.hint":
    "Kopiere diesen Token jetzt. Aus Sicherheitsgründen wird er nur dieses eine Mal angezeigt.",
  ...
  "screen:audit-log.title": "Ereignisprotokoll",
  ...
  "screen:my-caps.title": "Meine Nutzung",
  "screen:my-sessions.title": "Deine Sitzungen",
  "screen:page-edit.title": "Seite bearbeiten",
  "screen:page-list.title": "Seiten",
  "screen:platform-overview.title": "Übersicht",
  "screen:platform-tenant-caps.title": "Mandanten-Dashboard",
  ...
  "screen:tenant-cap-list.title": "Mandanten-Limits",
  ...
  "sessions.mine.col.current": "Dieses Gerät",
  "sessions.mine.col.ip": "IP-Adresse",
  "sessions.mine.col.userAgent": "Gerät",
  "sessions.mine.revoke": "Abmelden",
  "sessions.mine.revoke.confirm": "Dieses Gerät abmelden?",
  "sessions.mine.revokeAllOthers": "Alle anderen Geräte abmelden",
  "sessions.mine.revokeAllOthers.confirm": "Alle Geräte außer diesem abmelden?",
  ...
  "tags.manage.scopeLabel": "Geltungsbereich. Leer lassen, damit der Tag überall gilt.",
  "tags.manage.scopePlaceholder": "z. B. note",
  ...
  "tags.section.empty": "Noch keine Tags angelegt.",
  ...
  "template-resolver.editor.readOnly":
    "Nur lesbar. Änderungen erfordern die Rolle TenantAdmin oder SystemAdmin.",
  ...
  "tenant-settings.settings.system": "Standard-Mandanteneinstellungen",
  ...
  "tenant.members.filter.status.option.pending": "Ausstehend",
  ...
  "tenant:entity:__action-form__:field:role:option:User": "Benutzer",
  ...
  "tier-admin.error.load": "Mandanten konnten nicht geladen werden.",
  "tier-admin.error.noTiers":
    "Für diese App sind keine Tiers konfiguriert. Es gibt nichts, das sich zuweisen lässt.",
  ...
  "tier-admin.tenant.label": "Mandant",
  ...
  "userDataRights.errors.download.signedUrlNotSupported":
    "Der Download ist derzeit nicht möglich. Wir wurden bereits informiert, bitte versuche es später erneut.",
  ...
  "userDataRights.privacyCenter.restriction.explainer":
    "Die Verarbeitung deiner Daten wird pausiert, und du wirst sofort abgemeldet. Nur der Support kann die Einschränkung danach wieder aufheben.",
