...
export const localeDeBundle: Readonly<Record<string, string>> = {
  ...
  "cap-overview.errors.progressPrimitiveMissing":
    "Nutzungsbalken nicht verfügbar — Progress-Primitive ist nicht registriert.",
  ...
  "tier-admin.explainer":
    "Weise einem Mandanten ein Tier ohne Kauf zu. Der Grant wird als „manuell“ markiert und von einem späteren Billing-Sync nicht überschrieben.",
