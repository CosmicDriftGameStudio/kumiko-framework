...
export const frameworkEnCatalog: Readonly<Record<string, string>> = {
  ...
  "screen:my-sessions.title": "Your sessions",
  ...
  "sessions.mine.col.current": "This device",
  "sessions.mine.col.ip": "IP address",
  "sessions.mine.col.userAgent": "Device",
  "sessions.mine.revoke": "Sign out",
  "sessions.mine.revoke.confirm": "Sign this device out?",
  "sessions.mine.revokeAllOthers": "Sign out all other devices",
  "sessions.mine.revokeAllOthers.confirm": "Sign out every device except this one?",
