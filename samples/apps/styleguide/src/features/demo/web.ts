...
const en: Record<string, string> = {
  ...
  "styleguide:entity:item:field:isActive:option:true": "Active",
  "styleguide:entity:item:field:isActive:option:false": "Inactive",
...
const de: Record<string, string> = {
  ...
  "styleguide:entity:item:field:isActive:option:true": "Aktiv",
  "styleguide:entity:item:field:isActive:option:false": "Inaktiv",
  "styleguide:entity:item:field:status": "Status",
