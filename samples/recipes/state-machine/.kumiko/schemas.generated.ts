...
// billing:event:invoice-cancelled — from /Users/marc/code/cosmicdriftgamestudio/kumiko-framework-bun-cutover/samples/recipes/state-machine/src/feature.ts:50
export const _kg_billing__invoiceCancelled = z.object({});

// billing:event:invoice-marked-paid — from /Users/marc/code/cosmicdriftgamestudio/kumiko-framework-bun-cutover/samples/recipes/state-machine/src/feature.ts:49
export const _kg_billing__invoiceMarkedPaid = z.object({});

// billing:event:invoice-reopened — from /Users/marc/code/cosmicdriftgamestudio/kumiko-framework-bun-cutover/samples/recipes/state-machine/src/feature.ts:51
export const _kg_billing__invoiceReopened = z.object({});

// billing:event:invoice-sent — from /Users/marc/code/cosmicdriftgamestudio/kumiko-framework-bun-cutover/samples/recipes/state-machine/src/feature.ts:48
