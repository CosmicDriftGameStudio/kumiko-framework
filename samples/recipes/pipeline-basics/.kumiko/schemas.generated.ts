...
// inventory:event:product-archived — from /Users/marc/code/cosmicdriftgamestudio/kumiko-framework-int-rename/samples/recipes/pipeline-basics/src/feature.ts:92
export const _kg_inventory__productArchived = z.object({ reason: z.string() });

// inventory:event:product-stock-adjusted — from /Users/marc/code/cosmicdriftgamestudio/kumiko-framework-int-rename/samples/recipes/pipeline-basics/src/feature.ts:83
